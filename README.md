...
Retrieves the home page data including various anime sections such as spotlight animes, trending animes, latest episodes, and more. 

**✨ New Feature**: This endpoint now includes a **newAnimes** section that contains recently added anime content from the "New On HiAnime" section of the website. This provides easy access to the latest anime additions without requiring additional API calls.
...
```javascript
{
  ...
  data: {
    ...
    // Recently added anime content from "New On HiAnime" section
    newAnimes: [
      {
        id: string,
        name: string,
...
```javascript
{
  ...
  "data": {
    ...
    "spotlightAnimes": [
      {
        ...
        "poster": "https://cdn.noitatnemucod.net/thumbnail/300x400/100/bef8de77f63532b1e9c8bf5f6b132e8e.jpg",
        "description": "Humanity fights for survival against giant humanoid Titans.",
        "rank": 1,
        "otherInfo": ["TV", "25 eps", "Apr 2013"],
    ...
    "newAnimes": [
      ...
      {
        "id": "takopis-original-sin-19799",
        "name": "Takopi's Original Sin",
        "jname": "Takopii no Genzai",
        "poster": "https://cdn.noitatnemucod.net/thumbnail/300x400/100/be519acac4c3a026e537a674b608d860.jpg",
        "duration": "22m",
        "type": "ONA",
        "rating": null,
